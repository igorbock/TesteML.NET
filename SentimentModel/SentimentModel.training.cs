...
namespace SentimentModel.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"/home/igor/Área de Trabalho/Igote/TesteML.NET/yelp_labelled.txt";
